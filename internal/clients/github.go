...
const (
	keyBaseURL = "base_url" // optional GitHub Enterprise API endpoint
	keyOwner = "owner" 		// optional target GitHub organization or individual user account to manage
	keyToken = "token"		// GitHub OAuth / Personal Access Token
...
func TerraformSetupBuilder(version, providerSource, providerVersion string) terraform.SetupFn {
	return func(ctx context.Context, client client.Client, mg resource.Managed) (terraform.Setup, error) {
		...
		if v, ok := githubCreds[keyToken]; ok {
